...
// 1. Hubungkan semua file komponen yang dibutuhkan
require_once 'koneksi.php';
require_once 'classAnak.php';

// 2. Buat objek database untuk mengambil data
$db = new Database();
?>
